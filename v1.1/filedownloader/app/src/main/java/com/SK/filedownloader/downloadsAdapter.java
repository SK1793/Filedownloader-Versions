...
//                        percent.setText(Math.abs(D_progress[0])+"");
                    ...
                    if(tools.Status(current_pos.get_download_id(),getContext()).contains("Success")){
            ...
            handler.postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    switch (current_pos.get_type().toLowerCase()){
                        case "audio":file_icon.setImageResource(R.drawable.audio_file);
                            break;
                        case "text":file_icon.setImageResource(R.drawable.text_file);
                            break;
                        case "video":file_icon.setImageResource(R.drawable.video_file);
                            break;
                        case "application":
                            ...
                            }else if(current_pos.get_extension().contains("application")){
                                file_icon.setImageResource(R.drawable.apk_file);
                            }else{
                                file_icon.setImageResource(R.drawable.file);
                            }
