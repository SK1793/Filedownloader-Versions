...
public class MainActivity extends AppCompatActivity {
    ...
    String title, ext2, extension, geturl, final_title, extension_Edited, title_Edited, mime1, size, AltPath, Filename, PrevUrl = " ";
    ...
    String[] permissions, Extension_split;
...
//        Log.d(TAG, "Pre Columns Count "+ Arrays.toString(Fetcher.getColumnNames()));
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            permissions = new String[]{
                    ...
                    Manifest.permission.READ_MEDIA_VIDEO, Manifest.permission.MANAGE_EXTERNAL_STORAGE, Manifest.permission.POST_NOTIFICATIONS
            };
        } else {
            permissions = new String[]{
                    Manifest.permission.READ_EXTERNAL_STORAGE,
...
//                request.setVisibleInDownloadsUi(true);
                    ...
                    if (!(Filename == null)) {
                        ...
                        if (Filename.length() > 3) {
                            ...
                            if (Filename.contains(".")) {
                                ...
                                String[] title_split = Filename.split("\\.");
                                title = title_split[0];
                            }
                        }
                    }
                    ...
                    if (Custom_uri != null) {
                        ...
                        Log.d(TAG, "Custom_uri(DF) : " + Dir_split[1]);
                        Log.d(TAG, "Custom_uri(DF) : " + Custom_uri.getPath());
                        Log.d(TAG, "Custom_uri(DF) : " + Custom_uri.getPath().toString());
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (cursor1.moveToFirst()) {
                                ...
                                switch (CustomTools.Status(D_id, getApplicationContext())) {
                                    case "Downloading":
...
//                DbDownloader1.AddDownload(420,"filename", "extension", "some_uri", "some_url", 1234567);
                                        ...
                                        DbDownloader1.AddDownload(D_id, title, final_title, Extension_split[0], Downloaded_path[0], geturl, CustomTools.date_now(), Size, CustomTools.Status(D_id, getApplicationContext()));
//                ArrayList<downloads> some_list=DbDownloader1.fetchToArray(MainActivity.this);

                                        arr.add(new downloads(title, final_title, perce_tage, Extension_split[0], geturl, Uri.parse(Downloaded_path[0]), D_id,
                                                Extension_split[0], CustomTools.Status(D_id, getApplicationContext()), CustomTools.Status(D_id, getApplicationContext()), CustomTools.date_now(), Downloaded_path[0], Size));
...
//                .setAdapter(adapter);
                                        ...
                                        executor.execute(() -> {
                                            if (CustomTools.Status(D_id, getApplicationContext()).contains("Downloading")) {
...
//                lvDownloads_Section_current.setAdapter(adapter);\
                                    ...
                                    case "Pending":
                                        notificationLoader.execute();
                                        Toast.makeText(getApplicationContext(), "Download Pending or Paused", Toast.LENGTH_SHORT).show();
                                        break;
                                    default:
                                        notificationLoader.execute();
    ...
    public class NotificationLoader extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... voids) {
            ...
            builder.setSmallIcon(R.drawable.notification_icon)
                    .setContentTitle(CustomTools.Status(D_id, MainActivity.this))
                    .setBadgeIconType(NotificationCompat.BADGE_ICON_SMALL)
                    .setContentText(Filename + " | " + CustomTools.Percentage(D_id))
                    .setAutoCancel(true)
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                if (Nchannel == null) {
                    ...
                    Nchannel = new NotificationChannel(channel_ID, "Status: " + CustomTools.Status(D_id, MainActivity.this), importance);
